...
uint8_t rowsPin[numberOfRows] = {2, 3, 4, 5};             // ArduinoUNO开发板的2、3、4、5引脚分别接矩阵键盘的行引脚（1-4）
uint8_t columnsPin[numberOfColumns] = {6, 7, 8, 9};       // ArduinoUNO开发板的6、7、8、9引脚分别接矩阵键盘的列引脚（1-4）
