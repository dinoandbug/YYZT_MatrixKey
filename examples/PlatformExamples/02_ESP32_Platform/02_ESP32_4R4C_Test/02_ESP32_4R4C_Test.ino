...
uint8_t rowsPin[numberOfRows] = {13, 12, 14, 27};         // ESP32开发板的13、12、14、27引脚分别接矩阵键盘的行引脚（1-4）
uint8_t columnsPin[numberOfColumns] = {26, 25, 33, 32};   // ESP32开发板的26、25、33、32引脚分别接矩阵键盘的列引脚（1-4）
