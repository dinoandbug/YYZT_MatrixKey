...
#define numberOfRows 3                                    // 矩阵按键的行数
#define numberOfColumns 2                                 // 矩阵按键的列数
uint8_t rowsPin[numberOfRows] = {5, 4, 2};                // NodeMcu开发板的5、4、2引脚接矩阵键盘的行引脚（1-3）
uint8_t columnsPin[numberOfColumns] = {14, 12};           // NodeMcu开发板的14、12引脚接矩阵键盘的列引脚（1-2）
